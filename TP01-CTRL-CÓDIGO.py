...
#Consiste en armar un diccionario de dos claves y una lista de valores asociada a cada una.
...
#Cada posición i de 'tipos' y 'establecimientos' están relacionadas
...
#Queremos, para cada departamento, agregar a nuestro diccionario la información sobre su población
...
for fila in resultado.iterrows(): #importante: fila[0] es el índice de la fila, f[1] es la serie los valores de los distintos atributos
    ...
    #Primero vemos si nos encontramos con la información de otra área, o si ya terminamos el recorrido de la tabla 
    ...
    #Empezamos evaluando si estamos en edad infante. Evaluamos si la edad es de entre 3 y 5 (inclusive) años   
...
#Luego, a traves de una consulta SQL, juntamos el código de área, nombre de departamento y los datos poblacionales.
consultaSQL = """
                SELECT *
                FROM pp
                NATURAL JOIN dfaux
...
#Borramos las variables auxiliares usadas en el proceso.
del indice, fila, nombre, consultaSQL, departamentos_de_ciudad_bsas, departamentos_fuera_de_ciudad_bsas, pp
...
#Gráfico segundo ejercicio de visualización.
...
# Finalmente, creamos el gráfico y lo mostramos agregándole detalles estéticos.
...
plt.title("Cantidad de EE por departamento, ordenado por mediana, en cada provincia")
...
#Gráfico cuarto ejercicio de visualización.
...
#Y, además, buscamos analizar la existencia de relación entre éstas cantidades (a través de la distribución de los puntos en los ejes).
