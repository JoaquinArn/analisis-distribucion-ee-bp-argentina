...
# Ahora bien, queremos hacer cierta limpieza de datos, para asegurar consistencia entre tablas y que estén en 3FN.

#--Empezamos viendo atomicidad en el atributo mail --

#Primero vemos cuáles tienen alguno cargado. Pues, de lo contrario, el atributo ya es atómico
#Lo hacemos realizando la siguiente consulta SQL
"""
SELECT nro_conabip, id_departamento AS id_depto, mail, fecha_fundacion
FROM bibliotecas_populares
WHERE mail IS NOT NULL
"""
#devolvió 1022 filas. Una particularidad de los mails, es que todos llevan @. Comprobamos:
...
#--Vemos consistencia entre las distintas bases de datos--
